...
export class Toolbar {
  ...
  render(container) {
    ...
    toolbarElement.className = 'flex bg-zinc-800 justify-around absolute bottom-3 max-w-[350px] h-12 items-center left-[50%] border border-zinc-700 translate-x-[-50%] rounded-xl z-10 w-full left-1/2';
